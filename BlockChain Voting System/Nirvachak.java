...
public class Nirvachak extends JFrame {
    ...
    public Nirvachak() {
        setTitle("Nirvachak - Blockchain Voting System");
        ...
        // Main title
        JLabel titleLabel = new JLabel("🗳 Nirvachak - Blockchain Voting System", SwingConstants.CENTER);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Nirvachak::new);
    }
}
